...
object BlockChainUtil {
   ...
   */
  fun validateBlock(block: Block, parentTime: Long, parentHeight: Long, parentDifficulty: Long): Boolean {
    ...
    val difficulty = BlockChainUtil.getCurrentDifficulty(time, parentTime, parentHeight,
        parentDifficulty)
    val nonce = block.nonce

    val target = BigInteger("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF").divide(
  ...
  fun getCurrentDifficulty(blockNumber: Long, blockTime: Long, parentTime: Long,
